...
@about
	...
	- And many more.
@screenshot
	Image Preview https://github.com/Zly-u/NAGASHIZAR_reapack/blob/master/MIDI/MIDI_To_Items/img_MIDI2Items.png
@changelog
	- Added Option for skipping sampless channels.
	- Added Drag and Drop for swapping samples.
	- Added Drag and Drop files to assign samples
--]]